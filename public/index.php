...
$routes = [
    ...
    ['GET', '/products/edit', [Mini\Controllers\ProductController::class, 'showEditProductForm']],
    ['POST', '/products', [Mini\Controllers\ProductController::class, 'createProduct']],
    ['POST', '/products/update', [Mini\Controllers\ProductController::class, 'updateProduct']],
